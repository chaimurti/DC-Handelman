...
nu.deg = gamma.deg                                        %Degree of nu(x)
% P.deg = 4;                                              %Degree of polynomial to be decomposed
% offset_deg = 0;                                         %Degree offset
c1 = 4.9;
% c2 = 10;
...
P.coeffs = zeros(1,Coeff_total(n,P.deg+offset_deg));        %Set up a vector of coefficients for P(x)
...
Gamma_1 = [0 0 1 ; 0 1 0 ; r1 0 -1 ; r2 -1 0];
n_gamma_1 = 4;
%Set up second polytope
Gamma_2 = [0 0 1 ; 0 1 0 ; r1 0 -1 ; r2 -1 0];
n_gamma_2 = 4;
