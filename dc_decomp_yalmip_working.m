...
% %Set up first polytope
% Gamma_1 = [13 0 1 ; 12 1 0 ; 14 0 -1 ; 25 -2 -3];
% n_gamma_1 = 4;
% %Set up second polytope
% Gamma_2 = [13 0 1 ; 12 1 0 ; 14 0 -1 ; 25 -2 -3];
% n_gamma_2 = 4;
% 
% %Set up first polytope
% Gamma_1 = [50 0 1 ; 50 1 0 ; 100 0 -1 ; 100 -1 0];
% n_gamma_1 = 4;
% %Set up second polytope
% Gamma_2 = [50 0 1 ; 50 1 0 ; 100 0 -1 ; 100 -1 0];
% n_gamma_2 = 4;
...
gamma_sum = 0;
for i=1:gamma.coeff_total
    gamma_sum = gamma_sum + gamma_sdpvars{i};
end
T = trace(Const_nu{1}+Const_nu{2}+Const_nu{3});
 optimize(F,T);
